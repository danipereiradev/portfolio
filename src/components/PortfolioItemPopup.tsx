...
export const PortfolioItemPopup = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      ></div>
      <div className="fixed flex h-2/3 w-2/3 flex-col items-center justify-start gap-4 overflow-y-auto rounded-lg border border-slate-200 bg-black p-16 p-4 text-center shadow-lg lg:p-4">
